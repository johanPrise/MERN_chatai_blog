...
export const contentController = {
  // Post methods
  getAllPosts: async (req: ExtendedRequest, res: ExtendedResponse) => {
    try {
  ...
  getPostById: async (req: ExtendedRequest, res: ExtendedResponse) => {
    try {
  ...
  createPost: async (req: AuthRequest, res: ExtendedResponse) => {
    try {
  ...
  updatePost: async (req: AuthRequest, res: ExtendedResponse) => {
    try {
      const { title, content, category, featuredImage } = req.body;
  ...
  deletePost: async (req: AuthRequest, res: ExtendedResponse) => {
    try {
      const post = await Post.findById(req.params.id) as IPost | null;
  ...
  getCommentsByPost: async (req: ExtendedRequest, res: ExtendedResponse) => {
    try {
  ...
  addComment: async (req: AuthRequest, res: ExtendedResponse) => {
    try {
  ...
  updateComment: async (req: AuthRequest, res: ExtendedResponse) => {
    try {
      const { content } = req.body;
  ...
  deleteComment: async (req: AuthRequest, res: ExtendedResponse) => {
    try {
      const comment = await Comment.findById(req.params.commentId) as IComment | null;
  ...
  // Category methods
  getAllCategories: async (req: ExtendedRequest, res: ExtendedResponse) => {
    try {
  ...
  getCategoryById: async (req: ExtendedRequest, res: ExtendedResponse) => {
    try {
  ...
  createCategory: async (req: ExtendedRequest, res: ExtendedResponse) => {
    try {
  ...
  updateCategory: async (req: ExtendedRequest, res: ExtendedResponse) => {
    try {
      const { name, description } = req.body;
  ...
  deleteCategory: async (req: ExtendedRequest, res: ExtendedResponse) => {
    try {
      const category = await Category.findById(req.params.id) as ICategory | null;
